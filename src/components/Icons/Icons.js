const Upload = ({ width = '2rem', height = '2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
const Search = ({ width = '2.4rem', height = '2.4rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
const Messages = ({ width = '2.6rem', height = '2.6rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
const Inbox = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const GroupUser = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const GroupUserActive = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const Tag = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export const Music = ({ width = '3.2rem', height = '3.2rem', className }) => {
    return (
        <svg
            className={className}
            width={width}
...
export { Upload, Messages, Inbox, Search };
